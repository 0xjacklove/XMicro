...
def _kludge_use_TPopupMenu(*args) -> "void":
    r"""
...
def install_microcode_filter(*args) -> "void":
    r"""
...
class mbl_array_t(object):
    ...
    @staticmethod
    def deserialize(*args) -> "mbl_array_t *":
        r"""
...
def mbl_array_t_deserialize(*args) -> "mbl_array_t *":
    r"""
...
def gen_microcode(*args) -> "mbl_array_t *":
    r"""
