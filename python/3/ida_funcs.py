...
class stkpnt_array(object):
    ...
    __repr__ = _swig_repr
    data = property(_ida_funcs.stkpnt_array_data_get)
    count = property(_ida_funcs.stkpnt_array_count_get)
...
class regvar_array(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    data = property(_ida_funcs.regvar_array_data_get)
    count = property(_ida_funcs.regvar_array_count_get)
...
class range_array(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    data = property(_ida_funcs.range_array_data_get)
    count = property(_ida_funcs.range_array_count_get)
...
class func_t(ida_range.range_t):
    ...
    llabelqty = property(_ida_funcs.func_t_llabelqty_get, _ida_funcs.func_t_llabelqty_set)
    llabels = property(_ida_funcs.func_t_llabels_get, _ida_funcs.func_t_llabels_set)
